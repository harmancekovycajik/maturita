...
<body class="body"
  ...
  <div dir="ltr" class="es-wrapper-color" lang="en" style="background-color:#151515"><!--[if gte mso 9]>
      <v:background xmlns:v="urn:schemas-microsoft-com:vml" fill="t">
        <v:fill type="tile" color="#ffffff"></v:fill>
      </v:background>
    <![endif]-->
    <table width="100%" cellspacing="0" cellpadding="0" class="es-wrapper" role="none"
      style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#151515">
      <tr>
        <td valign="top" style="padding:0;Margin:0">
            ...
            <tr>
              <td align="center" style="padding:0;Margin:0">
                <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" class="es-header-body"
                  role="none"
                  style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#080609;width:600px">
                  <tr>
                        ...
                        <tr>
                          <td valign="top" class="esdev-mso-td" style="padding:0;Margin:0">
                            <table cellpadding="0" cellspacing="0" align="left" class="es-left" role="none"
                              ...
                              <tr>
                                <td valign="top" align="center" class="es-m-p0r" style="padding:0;Margin:0;width:415px">
                                  <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                    <tr>
                                      <td align="left" style="padding:0;Margin:0;font-size:0px; "><a target="_blank"
                                          href="<?= $url ?>"
                                          style="mso-line-height-rule:exactly;text-decoration:none;color:#926B4A;font-size:20px;font-family:arial, 'helvetica neue', helvetica, sans-serif;">La
                                          Flame Wear</a>
                                      </td>
                                    </tr>
                                  </table>
                                    ...
                                    <tr>
                                      <td style="padding:0;Margin:0">
                                        <table cellpadding="0" cellspacing="0" width="100%" class="es-menu"
                                          ...
                                          style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                          <tr class="images">
                                            <td align="center" valign="top" width="50%" id="esd-menu-id-0"
                                              ...
                                              <div style="vertical-align:middle;display:block">
                                                <a target="_blank" href="<?= $url ?>/login.php"
                                                  style="mso-line-height-rule:exactly;text-decoration:none;font-family:arial, 'helvetica neue', helvetica, sans-serif;display:block;color:#926B4A;font-size:14px"><img
                                                    src="https://eucqieh.stripocdn.email/content/guids/CABINET_455a2507bd277c27cf7436f66c6b427c/images/95531620294283439.png"
                                            ...
                                            <td align="center" valign="top" width="50%" id="esd-menu-id-2"
                                              style="Margin:0;border:0;padding-top:10px;padding-right:5px;padding-bottom:10px;padding-left:5px">
                                              <div style="vertical-align:middle;display:block">
                                                <a target="_blank" href="<?= $url ?>/kosik.php"
                                                  style="mso-line-height-rule:exactly;text-decoration:none;font-family:arial, 'helvetica neue', helvetica, sans-serif;display:block;color:#926B4A;font-size:14px"><img
                                                    src="https://eucqieh.stripocdn.email/content/guids/CABINET_455a2507bd277c27cf7436f66c6b427c/images/29961620294283034.png"
                                                    alt="Login" title="Login" width="20"
                                                    style="display:inline !important;font-size:14px;border:0;outline:none;text-decoration:none;vertical-align:middle"></a>
                                              </div>
                                            </td>
                          ...
                          <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0">
                                  <h1
                                    style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:30px;font-style:normal;font-weight:bold;line-height:36px;color:#fefefe">
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px">
                                  <p
                                    ...
                                    Your order has shipped. Here's some information on when to expect your package and
                                    how to track it along the way.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                ...
                <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" class="es-content-body"
                          ...
                          <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0">
                                  <h2
                                    style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:24px;font-style:normal;font-weight:bold;line-height:36px;color:#fefefe">
                                    ORDER # <?= $order['id'] ?></h2>
                                  <p
                                    style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#efefef;font-size:14px">
                                    <?= $order['created_at'] ?>
                  ...
                  <tr>
                    ...
                    <td align="left" class="esdev-adapt-off"
                      style="padding:0;Margin:0;padding-right:20px;padding-left:20px; padding-bottom: 20px; padding-top:40px;">
                      <table cellpadding="0" cellspacing="0" class="esdev-mso-table" role="none"
                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:560px">
                        <tr>
                          <td align="left" style="padding:0;Margin:0">
                            <p
                              style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#efefef;font-size:14px">
                              <span><?= $name ?>
                                <?= $surname ?></span><br><span><?= $order['phone'] ?></span><br><?= $order['address1'] ?>
                              <br>
                              <?= $order['address2'] ?>
                              <br><?= $order['city'] ?>
                              <?= $order['postal'] ?><br><?= $order['country'] ?>
                            </p>
                          </td>
                          <td valign="top" class="esdev-mso-td" style="padding:0;Margin:0">
                            <table cellpadding="0" cellspacing="0" align="left" class="es-left" role="none"
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                                    ...
                                    <tr>
                                      <td align="right" style="padding:0;Margin:0">
                                        <p
                                          style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#efefef;font-size:14px">
                                          Subtotal<br>Shipping<br><b>Total</b></p>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                                    ...
                                    <tr>
                                      <td align="right" style="padding:0;Margin:0">
                                        <p
                                          style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#efefef;font-size:14px">
                                          <?= $order['total'] ?>€<br><?= $order['shipping'] ?>€<br><strong><?= $order['final_total'] ?>€</strong>
                                        </p>
                                      </td>
                                    </tr>
                                  </table>
          ...
          <table cellpadding="0" cellspacing="0" align="center" class="es-footer" role="none"
            ...
            <tr>
              <td align="center" bgcolor="#ffffff" style="padding:0;Margin:0;background-color:#151515">
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                  <p
                                    style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#efefef;font-size:12px">
